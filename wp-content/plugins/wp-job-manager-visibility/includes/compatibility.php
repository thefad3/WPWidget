...
add_action( 'admin_notices', 'jmv_old_php_notice' );
add_action( 'admin_init', 'jmv_old_php_notice_ignore' );
...
if ( ! function_exists( 'jmv_old_php_notice_ignore' ) ) {

	function jmv_old_php_notice_ignore() {

		if ( isset( $_GET[ 'jmv_old_php_notice' ] ) && '0' == $_GET[ 'jmv_old_php_notice' ] ) {
			add_option( 'jmv_old_php_notice', 'true' );
		}
